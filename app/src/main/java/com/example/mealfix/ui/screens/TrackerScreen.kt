...
/**
 * The diet-tracking half of the app: log what you actually ate, and see how that stacks up
 * against the weekly calorie target set in the Plan tab.
 */
@Composable
fun TrackerScreen(
    meals: List<Meal>,
    ...
    onLogMeal: (mealId: String, day: Day, quantityKg: Double) -> Unit,
    ...
    Column(modifier = modifier.padding(16.dp)) {
        ...
        Text(
            "${totalKcalConsumed.toInt()} / ${weeklyTargetKcal.toInt()} kcal logged this week",
        ...
        if (meals.isEmpty()) {
            Text(
                "Add meals in the Library tab first.",
            ...
            Button(
                onClick = {
                    ...
                    if (meal != null && qty != null && qty > 0) {
                        onLogMeal(meal.id, selectedDay, qty)
                        quantityInput = ""
                    }
                },
                modifier = Modifier.padding(top = 8.dp),
                    ...
                    Card {
                        Row(
                            ...
                            Column {
                                ...
                                Text("${entry.quantityKg} kg")
                                if (meal != null) {
                                    Text("${entry.kcalConsumed(meal).toInt()} kcal")
                                }
                            }
